...
namespace Shajobe
{
    public partial class Producto_Elaborado : Form
    {
        public Producto_Elaborado()
        {
            InitializeComponent();
        }
        ...
        private System.Windows.Forms.PictureBox pic_ProductoElaborado;
        ...
        private void Diseño_Forma()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Producto_Elaborado));
            ...
            pic_ProductoElaborado = new System.Windows.Forms.PictureBox();
            ...
            ((System.ComponentModel.ISupportInitialize)(pic_ProductoElaborado)).BeginInit();
            ...
            menuStrip1.Size = new System.Drawing.Size(569, 24);
            ...
            lbl_Nombre.Location = new System.Drawing.Point(27, 46);
            ...
            lbl_Descripcion.Location = new System.Drawing.Point(27, 71);
            ...
            txt_Nombre.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Left)));
            txt_Nombre.Location = new System.Drawing.Point(126, 42);
            ...
            // txt_Descripcion
            // 
            txt_Descripcion.Location = new System.Drawing.Point(126, 67);
            ...
            Load += new System.EventHandler(Producto_Elaborado_Load);
            menuStrip1.ResumeLayout(false);
            menuStrip1.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)(errorProvider1)).EndInit();
            ((System.ComponentModel.ISupportInitialize)(pic_ProductoElaborado)).EndInit();
        ...
        private void Producto_Elaborado_Load(object sender, EventArgs e)
        {
            Diseño_Forma();
        }
        ...
        private void modificarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_ProductoElaborado_Cambios", con, tran);
                    comando.CommandType = CommandType.StoredProcedure;
                    comando.Parameters.Clear();
                    comando.Parameters.AddWithValue("@Id_ProductoElaborado", Idp);
        ...
        private void guardarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_ProductoElaborado_Altas", conexion, transaccion);
                    comando.CommandType = CommandType.StoredProcedure;
                    comando.Parameters.Clear();
                    comando.Parameters.AddWithValue("@Nombre", txt_Nombre.Text);
                    comando.Parameters.AddWithValue("@Descripcion", txt_Descripcion.Text);
        ...
        private void eliminarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conexion.Open();
                transaccion = conexion.BeginTransaction(System.Data.IsolationLevel.Serializable);
                OleDbCommand comando = new OleDbCommand("SP_ProductoElaborado_Bajas", conexion, transaccion);
                comando.CommandType = CommandType.StoredProcedure;
                comando.Parameters.Clear();
                comando.Parameters.AddWithValue("@Id_ProductoElaborado", Idp);
                comando.ExecuteNonQuery();
        ...
        public void BusquedaDatos(int Idp)
        {
            ...
            pic_ImagenContacto.ErrorImage = global::Shajobe.Properties.Resources.Producto_Elaborado;
            ...
            coman.CommandText = "Select * from Tb_ProductoElaborado where Id_ProductoElaborado='" + Idp + "'";
        ...
        private void Busqueda()
        {
            ...
            else
            {
                ...
                coman.CommandText = "Select * from Tb_ProductoElaborado  where Nombre='" + busqueda.ToUpper() + "' AND Activo='S'";
                coman.CommandType = CommandType.Text;
                con.Open();
                data_resultado.Rows.Clear();
                dr = coman.ExecuteReader();
                while (dr.Read())
                {
                    ...
                    data_resultado.Rows[Renglon].Cells["Id"].Value = dr.GetInt32(dr.GetOrdinal("Id_ProductoElaborado"));
        ...
        public static DataTable Datos()
        {
            ...
            string consulta = "SELECT * FROM Tb_ProductoElaborado where Activo='S'"; //consulta a la tabla paises
