...
namespace Shajobe
{
    public partial class Materia_PrimaP : Form
    {
        public Materia_PrimaP()
        {
            InitializeComponent();
        }
        ...
        private System.Windows.Forms.PictureBox pic_MateriaPrimaP;
        ...
        private void Diseño_Forma()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Materia_PrimaP));
            ...
            pic_MateriaPrimaP = new System.Windows.Forms.PictureBox();
            ...
            ((System.ComponentModel.ISupportInitialize)(pic_MateriaPrimaP)).BeginInit();
            ...
            menuStrip1.Size = new System.Drawing.Size(563, 24);
            ...
            pic_MateriaPrimaP.TabStop = false;
            // 
            // groupBoxdatos
            // 
            groupBoxdatos.Controls.Add(txt_Unidad);
            ...
            // txt_Unidad
            // 
            txt_Unidad.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Left)));
            txt_Unidad.Location = new System.Drawing.Point(126, 222);
            txt_Unidad.MaxLength = 2;
            txt_Unidad.Name = "txt_Unidad";
            txt_Unidad.Size = new System.Drawing.Size(127, 20);
            txt_Unidad.TabIndex = 56;
            txt_Unidad.KeyPress += new System.Windows.Forms.KeyPressEventHandler(txt_Unidad_KeyPress);
            // 
            // lbl_Unidad
            // 
            ...
            lbl_Unidad.Location = new System.Drawing.Point(27, 226);
            ...
            txt_Cantidad.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Bottom)
                        | System.Windows.Forms.AnchorStyles.Left)));
            txt_Cantidad.Location = new System.Drawing.Point(126, 196);
            txt_Cantidad.MaxLength = 9;
            txt_Cantidad.Name = "txt_Cantidad";
            txt_Cantidad.Size = new System.Drawing.Size(127, 20);
            txt_Cantidad.TabIndex = 53;
            ...
            lbl_Cantidad.Location = new System.Drawing.Point(27, 200);
            ...
            ClientSize = new System.Drawing.Size(563, 344);
            ...
            Text = "Materia prima";
            Load += new System.EventHandler(Materia_PrimaP_Load);
            menuStrip1.ResumeLayout(false);
            menuStrip1.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)(pic_MateriaPrimaP)).EndInit();
        ...
        private void Materia_PrimaP_Load(object sender, EventArgs e)
        {
            //Diseño de la forma
            Diseño_Forma();
            ...
            toolOpcion.SetToolTip(this.txt_Unidad, "Solo escribe la unidad con las siguientes opciones g, Kg, ml, L");
        }
        //-------------------------------------------------------------
        ...
        private void abrirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            data_resultado.Size = new System.Drawing.Size(470, 151);
        ...
        private void modificarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    OleDbCommand comando = new OleDbCommand("SP_MateriaPrimaP_Cambios", con, tran);
                    comando.CommandType = CommandType.StoredProcedure;
                    comando.Parameters.Clear();
                    comando.Parameters.AddWithValue("@Id_MateriaPrimaP", Idp);
                    ...
                    comando.Parameters.AddWithValue("@Unidad", txt_Unidad.Text);
        ...
        private void eliminarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conexion.Open();
                transaccion = conexion.BeginTransaction(System.Data.IsolationLevel.Serializable);
                OleDbCommand comando = new OleDbCommand("SP_MateriaPrimaP_Bajas", conexion, transaccion);
                comando.CommandType = CommandType.StoredProcedure;
                comando.Parameters.Clear();
                comando.Parameters.AddWithValue("@Id_MateriaPrimaP", Idp);
                comando.ExecuteNonQuery();
        ...
        public void BusquedaDatos(int Idp)
        {
            ...
            coman.CommandText = "Select * from Tb_MateriaPrimaP where Id_MateriaPrimaP='" + Idp + "'";
            ...
            while (dr.Read())
            {
                ...
                txt_Unidad.Text = dr.GetString(dr.GetOrdinal("Unidad"));
        ...
        private void Busqueda()
        {
            ...
            else
            {
                ...
                coman.CommandText = "Select * from Tb_MateriaPrimaP  where (Nombre='" + busqueda.ToUpper() + "'OR Clave='" + busqueda.ToUpper() + "') AND Activo='S'";
                coman.CommandType = CommandType.Text;
                con.Open();
                data_resultado.Rows.Clear();
                dr = coman.ExecuteReader();
                while (dr.Read())
                {
                    ...
                    data_resultado.Rows[Renglon].Cells["Id"].Value = dr.GetInt32(dr.GetOrdinal("Id_MateriaPrimaP"));
        ...
        private void Indicador_CamposVacios(int i)
        {
            switch (i)
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    errorProvider1.SetError(txt_Unidad, "No puedes dejar el campo vacio");
                    break;
                default:
                    break;
            }
        ...
        public static DataTable Datos()
        {
            ...
            string consulta = "SELECT * FROM Tb_MateriaPrimaP where Activo='S'"; //consulta a la tabla paises
